class Recorder:
    ...
    def getYouHaiState(self):
        return self.YouHaiState
    def getKeHuiShouState(self):
        return self.KeHuiShouState
    def getChuYuState(self):
        return self.ChuYuState
    def getQiTaState(self):
        return self.QiTaState
